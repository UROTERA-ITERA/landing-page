    ...
    <div className="bg-robot-gray-900 text-white">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 py-20 pt-32">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-robot-gray-300 mb-10 max-w-3xl mx-auto">
      ...
      <section className="bg-robot-gray-800 py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-robot-gray-700 p-8 rounded-lg">
      ...
      <section className="bg-robot-yellow-500 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-robot-gray-900 mb-6 font-display">
            Ready to Start Building?
          </h2>
          <p className="text-xl text-robot-gray-800 mb-10">
            Join our community today and get access to exclusive resources, events, and networking opportunities.
          </p>
          <button className="bg-robot-gray-900 text-white px-10 py-4 rounded-md font-bold text-lg hover:bg-robot-gray-800 transition-colors">
            Get Started Now
          </button>
        </div>
      </section>
